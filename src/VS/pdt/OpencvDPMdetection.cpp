...
OpencvDPMdetection::OpencvDPMdetection()
{
}
void OpencvDPMdetection::test(){
	help();
	...
	images_folder = "D:/baiducloud/tech/temp3/images";
	models_folder = "D:/baiducloud/tech/temp3/models";
